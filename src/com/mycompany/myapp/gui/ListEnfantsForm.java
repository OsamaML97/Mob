...
Form current;
    public ListEnfantsForm() {
        ...
        getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK,  e-> new EnfantWindow().show());
    }
