...
Form current;
    public ListEventsForm() {
        ...
        getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK,  e-> new EventWindow().show());
    }
